...
import { coreValues } from "../about/Our Core Values/CoreValue";
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          <p className="premium-copy mt-4 text-sm sm:text-base text-secondary dark:text-white/60 leading-relaxed">
            We align deep performance standards with uncompromised software
            parameters to output pure client execution.
          </p>
        </div>
              ...
              >
                <div className="flex flex-col h-full justify-between relative z-10">
                  <div>
                    {/* Icon Base */}
                    <div
                      className={`mb-6 flex h-12 w-12 items-center justify-center rounded-xl border border-slate-950/10 bg-white/70 ${value.color} transition-transform duration-500 group-hover:scale-110 group-hover:border-primary/20 dark:border-white/5 dark:bg-white/[0.03] dark:group-hover:border-white/10`}
                    >
